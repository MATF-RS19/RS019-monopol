...
CXXFLAGS      = -std=c++11 -m64 -pipe -O2 -D_REENTRANT -Wall -W -fPIE $(DEFINES)
INCPATH       = -I/usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64 -I. -I. -I/opt/Qt/5.3/Src/qtbase/include/QtWidgets -I/usr/include/qt5 -I/usr/include/qt5/QtWidgets -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtCore -I.
LINK          = g++
LFLAGS        = -m64 -Wl,-O1
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/RS019-monopol1.0.0/ && $(COPY_FILE) --parents ActionSpace.hpp AuctionHouse.hpp Bank.hpp Board.hpp Card.hpp Game.hpp mainwindow.h Player.hpp Property.hpp Railroad.hpp Space.hpp Utility.hpp .tmp/RS019-monopol1.0.0/ && $(COPY_FILE) --parents ActionSpace.cpp AuctionHouse.cpp Bank.cpp Board.cpp Card.cpp Game.cpp main.cpp mainwindow.cpp Player.cpp Property.cpp Railroad.cpp Space.cpp Utility.cpp .tmp/RS019-monopol1.0.0/ && (cd `dirname .tmp/RS019-monopol1.0.0` && $(TAR) RS019-monopol1.0.0.tar RS019-monopol1.0.0 && $(COMPRESS) RS019-monopol1.0.0.tar) && $(MOVE) `dirname .tmp/RS019-monopol1.0.0`/RS019-monopol1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/RS019-monopol1.0.0
